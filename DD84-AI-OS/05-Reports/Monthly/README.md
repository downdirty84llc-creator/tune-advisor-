...
Measure it as: _actions completed without owner involvement / total actions in that area._ A number that is high because volume is low is not progress — report volume alongside it.
